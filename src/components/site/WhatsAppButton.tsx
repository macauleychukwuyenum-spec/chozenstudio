...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="group fixed z-50 right-4 bottom-40 md:bottom-28 h-13 w-13 rounded-full grid place-items-center shadow-xl transition hover:scale-110 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400"
